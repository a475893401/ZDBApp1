...
import com.superlibrary.util.NetworkUtils;
...
public class SuperRecyclerView extends RecyclerView {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 && layoutManager.getItemCount() > layoutManager.getChildCount() && !isNoMore && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
                ...
                onScrollBottomListener.isScorllLastIndex(lastVisibleItemPosition);
            }
        }
    }
    ...
    private OnScrollBottomListener onScrollBottomListener = new OnScrollBottomListener() {
        ...
        @Override
        public void isScorllLastIndex(int index) {
//            Log.e("superRec ---",index+"-----------");
            mLoadingListener.isLastIndex(index);
        }
    };
    ...
    public interface LoadingListener {
        ...
        void isLastIndex(int isLastIndex);
...
//    }
    ...
    private int measureHeight(int measureSpec) {
        ...
        Log.e("measureHeight","specMode="+specMode);
        Log.e("measureHeight","specSize="+specSize);
        int result = 500;
    ...
    private int measureWidth(int measureSpec) {
        int specMode = MeasureSpec.getMode(measureSpec);
        int specSize = MeasureSpec.getSize(measureSpec);
        Log.e("measureWidth","specMode="+specMode);
        Log.e("measureWidth","specSize="+specSize);
        int result = 500;
        if (specMode == MeasureSpec.AT_MOST){
            result = specSize;
        } else if (specMode == MeasureSpec.EXACTLY){
