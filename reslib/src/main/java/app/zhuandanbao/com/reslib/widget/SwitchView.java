...
public class SwitchView extends View {
	...
	@Override protected void onDraw(Canvas canvas) {
		...
		//paint.setColor(isOn ? 打开颜色 : 关闭颜色);
		//0xff4bd763  0xffe3e3e3
		paint.setColor(isOn ? 0xffBBBBBB  : 0xffe3e3e3); 
		...
		paint.setColor(0xff2380cd);//关闭时滑动拖拽颜色
//		paint.setColor(0xffffccdd);
		canvas.drawPath(sPath, paint);
		canvas.restore();
		// draw center bar
		canvas.save();
