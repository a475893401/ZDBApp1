...
public class GeneratePictureView extends FrameLayout{
    ...
    public void changeDay(String strData,String userInfo,String userName,String other) {
        ...
        if(other == null)
            other ="";
        String data= "<h3 style=\"color:#666666;text-align:center;margin-top:20px;\">"+userInfo+"</h3>"
                + "<p style=\"color: #999999;letter-spacing: 0.5px;text-align:right;\">作者：<span style=\"text-decoration: underline;\">"+userName+"</span>&nbsp;&nbsp;<span>"+other+"</span></p><br/>"
                + strData;
