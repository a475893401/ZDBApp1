...
public class JGUtil {
     ...
     *            布局Id
     */
    public static void customPushNotification(Context context, int number, int layoutId) {
        // 指定定制的 Notification Layout
        CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(
                context, layoutId, R.id.icon,
                R.id.title,
        ...
        // 指定下拉状态栏时显示的通知图标
        builder.layoutIconDrawable = R.mipmap.zhuandanbao_logo;
        JPushInterface.setPushNotificationBuilder(number, builder);
    }
    ...
    public static class localNotificationBuilder {
        ...
        public localNotificationBuilder setBroadcastTime(int year, int month, int day, int hour, int minute, int second) {
    ...
    public static void showLocalNotification(Context context, long number,
        ...
        JGUtil.localNotificationBuilder builder = new localNotificationBuilder(
                context);
