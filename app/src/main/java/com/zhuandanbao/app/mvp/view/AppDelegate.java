...
public abstract class AppDelegate implements IDelegate {
    ...
    public <D extends ViewDataBinding> D create(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        int rootLayoutId = getBaseLayoutId();
        ...
        content = (FrameLayout) rootView.findViewById(R.id.content_view);
        return binding;
    }
    ...
    public Toolbar getToolbar() {
        Toolbar toolbar = (Toolbar) rootView.findViewById(R.id.base_top_toolBar);
        if (null != toolbar) {
            return toolbar;
        }
        return null;
