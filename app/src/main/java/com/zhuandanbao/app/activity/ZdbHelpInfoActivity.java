...
public class ZdbHelpInfoActivity extends BaseListViewActivity<LjListViewD> {
    ...
    private void getMsgInfo() {
        ...
        params.put("help_id", indexEntity.pushId);
        baseHttp(null, true, Constants.API_HELP_CONTENT, params);
    }
}
