...
import com.zhuandanbao.app.fragment.BillInfoFragment;
...
public class BillOrderInfoActivity extends BaseListViewActivity<OrderTopD> implements ViewPager.OnPageChangeListener {
    private CustomPagerSlidingTabStrip topTab;
    private MyViewPager myViewPager;
    private TopFragmentAdapter topFragmentAdapter;
    private TextView back;

    private String[] tabTitle = {"发单详情", "订单跟踪"};
    private static final int VIEW_1 = 0;
    private static final int VIEW_2 = 1;

    private static int VIEW_SIZE = 2;
    private BillInfoFragment billOrderFragment = null;
                ...
                switch (position) {
                    case VIEW_1:
                        if (null == billOrderFragment)
                            billOrderFragment = BillInfoFragment.getInstance(skipInfoEntity.pushId);
