...
public class TakingInfoLogFragment extends BaseListViewFragment<ShopD> {
    private String orderSn=null;
    private RvBaseAdapter adapter;
    private List<InfoLogEntity> list=new ArrayList<>();
    private View topView;

    public static TakingInfoLogFragment getInstance(String orderSn) {
        TakingInfoLogFragment fragment = new TakingInfoLogFragment();
    ...
    private void getIngoLog(){
        ...
        baseHttp(null,true,Constants.API_ORDER_INFO_TAIL,params);
    }
}
