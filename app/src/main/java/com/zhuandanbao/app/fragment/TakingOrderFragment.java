...
public class TakingOrderFragment extends BaseListViewFragment<OrderListTopD> implements ViewPager.OnPageChangeListener {
    ...
    private TakingOrderListFragment fragment1 = null, fragment2 = null, fragment3 = null, fragment4 = null, fragment5 = null;

    public static TakingOrderFragment getInstance() {
        ...
        public Fragment getItem(int position) {
            if (position >= 0 && position < VIEW_SIZE) {
                switch (position) {
                    case VIEW_1:
                        if (null == fragment1)
                            fragment1 = TakingOrderListFragment.getInstance(VIEW_1);
                        return fragment1;
                    case VIEW_2:
                        if (null == fragment2)
                            fragment2 = TakingOrderListFragment.getInstance(VIEW_2);
                        return fragment2;
                    case VIEW_3:
                        if (null == fragment3)
                            fragment3 = TakingOrderListFragment.getInstance(VIEW_3);
                        return fragment3;
                    case VIEW_4:
                        if (null == fragment4)
                            fragment4 = TakingOrderListFragment.getInstance(VIEW_4);
                        return fragment4;
                    case VIEW_5:
                        if (null == fragment5)
                            fragment5 = TakingOrderListFragment.getInstance(VIEW_5);
                        return fragment5;
                }
            }
            return null;
