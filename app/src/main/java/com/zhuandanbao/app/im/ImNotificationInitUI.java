...
public class ImNotificationInitUI extends IMNotification {
    ...
    public static void init() {
        ...
        if (imKit != null) {
            ...
            mNeedSound = (ImSoundKVStore.getNeedSound() == 1);
            mNeedVibrator = (ImSoundKVStore.getNeedVibration() == 1);
        }
    }

    @Override
    public Intent getCustomNotificationIntent(Intent intent, YWConversation conversation, YWMessage message, int totalUnReadCount) {
...
//        return intent;
        return super.getCustomNotificationIntent(intent, conversation, message, totalUnReadCount);
    }
...
//        return intent;
    ...
    public int getNotificationIconResID() {
        return R.mipmap.zhuandanbao_logo;
    }
