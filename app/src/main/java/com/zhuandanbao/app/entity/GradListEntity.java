...
public class GradListEntity implements Serializable {
    ...
    public String getIs_self_create() {
        return is_self_create;
    }

    public void setIs_self_create(String is_self_create) {
        this.is_self_create = is_self_create;
    }
    ...
    public String getReceive_shop_name() {
        return receive_shop_name;
    }

    public void setReceive_shop_name(String receive_shop_name) {
        this.receive_shop_name = receive_shop_name;
    }
